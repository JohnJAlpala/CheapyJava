...
//        request.setAttribute("tipoUsuario", session.getAttribute("tipoUsuario"));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(accion.equals("ficticios"));
        
        if (accion.equals("ficticios") && ficticios == false) { // GENERAR DATOS FICTICIO
            System.out.println("Generando Ficticios");
            ...
            System.out.println("SET DTOS FIC");

            RequestDispatcher view = request.getRequestDispatcher("index.jsp");
            view.forward(request, response);
        } else if ((boolean)session.getAttribute("ficticios") == true){
            System.out.println("ERROR DTOS FICT");
